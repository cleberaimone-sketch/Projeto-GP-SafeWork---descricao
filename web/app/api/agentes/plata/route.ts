...
import { plataResponder, type Mensagem } from '@/lib/agentes/plata/claude'
...
export async function POST(req: NextRequest) {
  ...
  const { resposta, tokensUsados } = await plataResponder(pergunta, historico as Mensagem[], user.id)
