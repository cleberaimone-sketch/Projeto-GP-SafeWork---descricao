    ...
    <main className="min-h-screen bg-gray-950 text-white p-6 md:p-8">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-4 mt-2">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Organização pessoal · WhatsApp · Casa · Computador</p>
          </div>
          <div className="ml-auto flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-violet-400 animate-pulse" />
            <span className="text-xs text-violet-400">Monitorando</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2">
          <h2 className="text-sm font-semibold text-gray-400 mb-3">Chat com Aimone</h2>
        ...
        <div className="space-y-4">
          <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
            ...
            {conversasMonitoradas.length === 0 ? (
              <p className="text-xs text-gray-500">Nenhuma conversa pessoal monitorada ainda</p>
            ) : (
                ...
                {conversasMonitoradas.map((c, i) => {
                  ...
                  return (
                    <div key={i} className="border-b border-gray-800 pb-2 last:border-0">
                      <p className="text-xs font-medium text-violet-300">{c.contato_nome}</p>
                      {ultima && (
                        <p className="text-xs text-gray-400 truncate mt-0.5">{ultima.content.slice(0, 80)}</p>
                      )}
          ...
          <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Pergunte ao Aimone</h3>
